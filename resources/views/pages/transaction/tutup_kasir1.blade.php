...
<script src="{{ asset('assets/js/jquery.PrintArea.js') }}" type="text/JavaScript"></script>
    <script>
        ...
        $("#today").click(function(){
            ...
            $.get('/kasir1/cpo_phg', {from_date:from_date}, function(data){
            ...
            $.get('/kasir1/acit', {from_date:from_date}, function(data){
                        $('#acit_forum').val(data);
            ...
            $.get('/kasir1/olin', {from_date:from_date}, function(data){
                        $('#olin_forum').val(data);
            ...
            $.get('/kasir1/pko', {from_date:from_date}, function(data){
                        $('#pko_forum').val(data);
            ...
            $.get('/kasir1/bulking', {from_date:from_date}, function(data){
            ...
            $.get('/kasir1/smart_cpo', {from_date:from_date}, function(data){
                        $('#cpo_setoran').val(data);
                        var kartu = data * 2000;
                        $('#cpo_kartu_smart').val(kartu);                          
            });

            $.get('/kasir1/smart_inti', {from_date:from_date}, function(data){
                        $('#inti_setoran').val(data);
                        var kartu = data * 5000;
                        $('#inti_kartu_smart').val(kartu);                          
            });

            $.get('/kasir1/phg', {from_date:from_date}, function(data){
