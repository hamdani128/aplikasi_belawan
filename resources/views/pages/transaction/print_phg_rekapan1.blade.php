...
@section('content')
@section('title', 'Print Rekapan PT Phg 1')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Rekap Data Transaksi PT Phg (Shift1)</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-lg-12 printableArea">
                            <div class="row">
                                <h5>Rekap Data Transaksi PT Phg Shift1</h5>
                            </div>
                            <div class="row">
