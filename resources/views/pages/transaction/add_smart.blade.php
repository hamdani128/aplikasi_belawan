...
@section('content')
@section('title', 'Modul Transaksi | Transaksi Smart')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title"> Tambah Data Transaksi Pendapatan ( PT.SMART )</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-lg-4 col-xl-4">
            <div class="card card-ouline-warning">
                ...
                <div class="card-body">
                <form action="{{ route('create-transaction-smart') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="row">
                        <div class="col-md-12">
