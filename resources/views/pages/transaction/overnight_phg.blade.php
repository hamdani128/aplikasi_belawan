...
@section('content')
@section('title', 'Modul Transaksi | Pendapatan Bermalam Phg')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title"> Tambah Data Pendapatan Malam ( Pt.Phg ) </h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-12">
            <div class="card card-ouline-warning">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">No.Kendaraan : {{ $transactionphg->trucks->no_kendaraan }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('create-overnightphg', $transactionphg) }}" method="POST">
                        {{ csrf_field() }}
                        <div class="row">
                        <div class="col-md-12">
