...
@section('content')
@section('title', 'Print Rekapan Smart 2')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Shift 2</li>
                    </ol>
                </div>
                <h4 class="page-title">Rekap Data Transaksi PT Smart (Shift2)</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-lg-12 printableArea">
                            <div class="row">
                                <h5>Rekap Data Transaksi PT Smart Shift2</h5>
                            </div>
                            <div class="row">
