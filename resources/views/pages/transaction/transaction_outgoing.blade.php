                                    ...
                                    @forelse ($troutgoing as $item)
                                        <tr>
                                            ...
                                            <td class="row">
                                                ...
                                                <div class="mr-1 mb-1">
                                                    <a href="/print_out/transaction_outgoing/{{$item->id}}" class="btn-md btn btn-info"  data-toggle="tooltip" data-placement="right" title="Cetak Data Peritem"><i class=" uil-print"></i></a>               
                                                </div>
                                            </td>
                                            @endcan
                                        </tr>
